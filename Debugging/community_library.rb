...
# The error occured because the code was attempting to call `Book#display_data` on the array of collaborator objects instead of each individual collaborator object.